...
This shows an observer moving relative to the rod measures a shorter length than an observer at rest with respect to it.
:::

```{python}
#| label: fig-length-contraction
#| fig-cap: Example of how long 1 meter rod would appear to an observer as they moved at different fractions of the speed of light
