...
- `Dark Mode` available in the top-right
:::
...
:::{.column-screen-inset-shaded}
![](imgs/THE-HAND.jpg){group="gallery"}
:::
...
:::
::: {.g-col-6}
![The Hand](imgs/The-hand.jpg){#fig-hanno group='mini'}
:::
:::
...
:::
::: {.g-col-6}
![Lion God - Absolutely disgusting, one of my favorites](imgs/Lion-God.jpg){#fig-hanno group='mini'}
:::
:::
